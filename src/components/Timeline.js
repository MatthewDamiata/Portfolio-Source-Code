    ...
    return (
      <VerticalTimeline className="custom-line">
        <VerticalTimelineElement
          ...
          dateClassName="dates"
          contentStyle={{ background: 'rgb(51, 154, 51)', color: '#fff' }}
          contentArrowStyle={{ borderRight: '7px solid  rgb(51, 154, 51)' }}
          date="2019 - 2022"
          iconStyle={{ background: 'rgb(51, 154, 51)', color: '#fff' }}
        ...
        >
          ...
          <p>
            Data Governance, Data Quality, Automation
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <h4 className="vertical-timeline-element-subtitle">Bachelor of Science in Computer Science</h4>
          <p>
            Started earning my degree in Computer Science
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
